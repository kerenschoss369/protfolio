...
| 2026-08-05 | Visual redesign     | Homepage copy cut; sticky featured stack; device mockups; case-study disclosures; capabilities | MotionSites-inspired presentation without template copy; text density was the core problem                                                  | `docs/visual-redesign-plan.md`, homepage/work/about/contact/case-study                               |
