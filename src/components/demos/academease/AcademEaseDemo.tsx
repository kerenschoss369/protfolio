    ...
    >
      <div className="space-y-5 p-4 sm:p-5">
        <div lang="en" className="space-y-4">
          <SimulationNotice label="Portfolio simulation — fictional academic data only." />
        ...
        <div dir={isRtl ? "rtl" : "ltr"} lang={language} className="space-y-5">
          ...
          <section aria-label={copy.scheduleLabel} className="space-y-3">
            ...
            >
              ...
              >
                {copy.summaryLabel}: illustrative comparison only — not
                production AcademEase metrics.
              </Text>
            </aside>
          </section>
