    ...
    >
      <Container>
        <Reveal>
          <div
            data-theme-surface
            className="border-border-subtle rounded-[var(--radius-lg)] border bg-[linear-gradient(135deg,var(--surface-1),color-mix(in_srgb,var(--accent)_8%,var(--background)))] px-6 py-10 sm:px-10 sm:py-12"
          >
